...
- Keep public health, authenticated info/wake, pairing enrollment/status, input, and power routes deliberately separate. Network reachability is never authorization.
